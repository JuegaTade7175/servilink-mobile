  ...
  return (
    <ScrollView style={s.container} contentContainerStyle={s.scroll}>
      ...
      <View style={s.card}>
        ...
        <View style={s.separator} />
        <InfoRow icon="🏷️" label="Rol" value={user?.role === 'CLIENT' ? 'Cliente' : 'Profesional'} />
        <View style={s.separator} />
      ...
      <View style={s.card}>
        ...
        >
          {saving ? <ActivityIndicator size="small" color="#fff" /> : <Text style={s.saveBtnText}>Guardar foto</Text>}
        </TouchableOpacity>
      </View>
...
const ir = StyleSheet.create({
  ...
  label: { fontSize: 10, color: '#9ca3af', fontWeight: '700', textTransform: 'uppercase' },
...
const s = StyleSheet.create({
  ...
  avatar: { width: 88, height: 88, borderRadius: 44, borderWidth: 3, borderColor: '#6c63ff' },
  avatarFallback: {
  ...
  removePhotoBtn: {
    ...
    backgroundColor: '#ef4444', borderRadius: 11,
    justifyContent: 'center', alignItems: 'center',
  },
  ...
  card: {
    ...
    borderWidth: 1, borderColor: '#e5e7eb', elevation: 1, gap: 12,
  },
